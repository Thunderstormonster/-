...
{ //	0   -  9   -  системные
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(33, "Больше чем 1 сивол в символьном типе char"),
		ERROR_ENTRY_NODEF(34), ERROR_ENTRY_NODEF(35),
		...
		ERROR_ENTRY(96, "Неверная структура условного оператора if"), 
