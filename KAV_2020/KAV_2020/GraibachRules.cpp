...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 7,
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 2, 19,  // возможные конструкции в ф-иях
			...
			Rule::Chain(5, TS('t'), TS('C'), TS('i'), TS(';'), NS('N')),
			Rule::Chain(5, TS('t'), TS('s'), TS('i'), TS(';'), NS('N')),
			Rule::Chain(5, TS('i'), TS('='), NS('E'), TS(';'), NS('N')),
			Rule::Chain(8, TS('c'), TS('('), TS('i'), TS(','), TS('i'), TS(')'), TS(';'), NS('N')),
			Rule::Chain(8, TS('c'), TS('('), TS('l'), TS(','), TS('l'), TS(')'), TS(';'), NS('N')),
			Rule::Chain(8, TS('T'), TS('('), TS('i'), TS(','), TS('i'), TS(')'), TS(';'), NS('N')),
			Rule::Chain(8, TS('T'), TS('('), TS('l'), TS(','), TS('l'), TS(')'), TS(';'), NS('N')),
			Rule::Chain(5, TS('b'), TS(';'), TS('b'), TS(';'), NS('N')),
			...
			Rule::Chain(18, TS('I'), TS('('), TS('i'), NS('L'), TS('i'), TS(')'), TS('{'), TS('o'), NS('E'), TS(';'), TS('}'), TS('G'), TS('{'), TS('o'), NS('E'), TS(';'), TS('}'), NS('N')),
			Rule::Chain(17, TS('I'), TS('('), TS('i'), NS('L'), TS('i'), TS(')'), TS('{'), TS('o'), NS('E'), TS(';'), TS('}'), TS('G'), TS('{'), TS('o'), NS('E'), TS(';'), TS('}'))
			
		),
		Rule(NS('E'), GRB_ERROR_SERIES + 3, 18, //описыв выражения
			Rule::Chain(1, TS('i')),
		...
		Rule(NS('L'), GRB_ERROR_SERIES + 6, 6, // опис арифметич знаки
			Rule::Chain(1, TS('!')),
			Rule::Chain(1, TS('>')),
			Rule::Chain(1, TS('<')),
			Rule::Chain(1, TS('&')),
