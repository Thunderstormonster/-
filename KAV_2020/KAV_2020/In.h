...
/*2*/	IN::PR, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::L, IN::SEP, IN::SEP, IN::SEP,  IN::SEP, IN::SEP, IN::SEP, IN::T, IN::SEP,\
/*3*/	IN::T,  IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T,   IN::T,   IN::T,    IN::SEP, IN::T,   IN::SEP, IN::T, IN::T,\
